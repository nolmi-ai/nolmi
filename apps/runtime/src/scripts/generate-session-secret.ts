...
//
// One-Shot CLI für NOLMI_SESSION_SECRET. iron-session braucht mind. 32
// Zeichen — wir geben hex-encodete 32 Bytes (= 64 hex-chars) aus, das
// erfüllt das Limit zweifach.
//
// Aufruf: pnpm --filter @nolmi/runtime session-secret:generate
//
// Wichtig: separater Wert von NOLMI_ENCRYPTION_KEY (verschlüsselt
...
console.log(`NOLMI_SESSION_SECRET=${secret}`);
console.log("");
