...
**Jetzt klar sichtbare nächste Fronten (Launch-Vorbereitung, nicht heute zwingend):** `always_pending`-Onboarding-Politur (jetzt live-relevant, da `npm i -g` real ist — frischer Twin antwortet sonst nie sofort), volle #112-Landing (ersetzt Apex-Platzhalter, braucht Pitch/Hero-GIF), #3-Live-Test (Nicht-Owner), Repo-Description EN. **Erst wenn die rund sind: lauter Launch (HN/Twitter).**
